    ...
    <div className="seller-dashboard">
      ...
      {activeTab === "dashboard" && (
        <>
          <div className="stats-grid">
            <div className="stat-card">📦 Projects<br />{projects.length}</div>
            <div className="stat-card">💰 Sales<br />{payments.length}</div>
            <div className="stat-card">₹ Earnings<br />₹{totalEarnings}</div>
          </div>
      ...
      {activeTab === "add" && (
        <form className="add-project-form" onSubmit={handleAddProject}>
          ...
          <input placeholder="Live Preview" value={livePreview} onChange={e => setLivePreview(e.target.value)} />
          <input placeholder="Video Demo" value={videoDemo} onChange={e => setVideoDemo(e.target.value)} />
...
/>
          <button disabled={uploading}>{uploading ? "Uploading..." : "Add Project"}</button>
        </form>
      )}
  ...
  >
    ...
    >
      ...
      <div className="project-links">
        <a href={selectedProject.livePreview} target="_blank" rel="noreferrer">Live</a>
        <a href={selectedProject.githubLink} target="_blank" rel="noreferrer">GitHub</a>
        <button 
